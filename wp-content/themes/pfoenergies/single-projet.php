...
<?php get_header(); ?>
    ...
    <div class="max-w-7xl mx-auto py-8 mt-14">
        ...
        <article class="w-full">
            ...
            <?php 
            $status = get_the_terms(get_post(), 'projet_status');
            $location = get_the_terms(get_post(), 'projet_location');
            ?>
    ...
    <div class="max-w-7xl mx-auto mt-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="w-full h-80 bg-cover bg-center bg-no-repeat shadow-xl/20" style="background-image: url('<?= wp_get_attachment_image_url($image->ID, 'projet-gallery'); ?>');"></div>
            <?php endforeach ?>
        </div>
    </div>
