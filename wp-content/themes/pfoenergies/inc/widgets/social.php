...
class Pfoenergies_Social_Widget extends \WP_Widget {

    public $fields = [];

    public function __construct()
    {
        parent::__construct('pfoenergies_social_widget', __('Social widget', 'pfoenergies'));
        $this->fields = [
            'title' => __('Title', 'pfoenergies'),
            'credits' =>  __('Credits', 'pfoenergies'),
            'twitter' => 'Twitter',
            'facebook' => 'Facebook',
            'instagram' => 'Instagram',
        ];
